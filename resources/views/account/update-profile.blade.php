                ...
                @endif                
                    <form method="POST" action="{{ route('update_profile') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="middle_name" type="text" class="form-control @error('middle_name') is-invalid @enderror" name="middle_name" value="{{ old('first_name', $user->middle_name) }}" autocomplete="middle_name" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="contact_no" type="text" class="form-control @error('contact_no') is-invalid @enderror" name="contact_no" value="{{ old('contact_no', $user->contact_no   ) }}" required autocomplete="contact_no" autofocus>
